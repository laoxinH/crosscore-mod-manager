...
import top.laoxin.modmanager.data.antiHarmony.AntiHarmonyDao
import top.laoxin.modmanager.data.backups.BackupDao
import top.laoxin.modmanager.data.mods.ModDao

@Database(entities = [ModBean::class, BackupBean::class, AntiHarmonyBean::class], version = 3, exportSchema = false)
